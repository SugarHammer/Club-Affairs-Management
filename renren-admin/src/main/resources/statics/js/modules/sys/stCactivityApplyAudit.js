$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/stCactivityApply/auditList',
        datatype: "json",
        colModel: [
            { label: 'id', name: 'id', index: 'id', width: 20 },
            { label: '活动名称', name: 'name', index: 'name', width: 60 },
            { label: '社团名称', name: 'club', index: 'club', width: 100 },
            ...
            { label: '类型', name: 'sort', index: 'sort', width: 100 },
            { label: '活动介绍', name: 'dc', index: 'dc', width: 100 },
            { label: '注意事项', name: 'matters', index: 'matters', width: 100 },
            {label: '审批状态', name: 'state', index: 'state', width: 80},
